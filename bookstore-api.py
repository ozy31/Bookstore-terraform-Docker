...
app.config['MYSQL_DATABASE_USER'] = 'XXXXXX' #CHANGE HERE !!!!!!!!!
app.config['MYSQL_DATABASE_PASSWORD'] = 'XXXXXXXX' #CHANGE HERE !!!!!
...
# Write a function named `home` which returns 'Welcome to the Ozzy's Bookstore API Service',
# and assign to the static route of ('/')
@app.route('/')
def home():
    return "Welcome to Ozzy's Bookstore API Service"
